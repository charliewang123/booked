...
def get_book_info():
    # Update keywords to history-related ones
    history_keywords = ['history', 'historical', 'past', 'ancient', 'civilization', 'chronicle', 'biography']
...
if __name__ == "__main__":
    try:
        # Fetch history books and print them as JSON
