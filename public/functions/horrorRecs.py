...
def get_book_info():
    # Update keywords to horror-related ones
    horror_keywords = ['horror', 'thriller', 'ghost', 'haunted', 'dark', 'suspense', 'mystery']
...
if __name__ == "__main__":
    try:
        # Fetch horror books and print them as JSON
