...
def get_book_info():
    # Update keywords to adventure-related ones
    adventure_keywords = ['adventure', 'exploration', 'journey', 'expedition', 'action', 'thriller', 'quest']
...
if __name__ == "__main__":
    try:
        # Fetch adventure books and print them as JSON
